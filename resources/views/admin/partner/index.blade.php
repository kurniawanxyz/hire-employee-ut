            ...
            <div class="content container-fluid">
                <div class="page-header mb-3">
                    <div class="card px-3 py-3 mb-4 flex-md-row justify-content-between align-items-center">
                        ...
                        <div class="text-end">
                            <a href="{{ route('admin.partner.create') }}" class="btn btn-outline-primary">Add Customer/Patner</a>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.partner.edit', $item->id) }}"><i
                                                                class="fa-solid fa-pencil m-r-5"></i>
                                                            Edit</a>
                                                        <form nameData="{{ $item->name }}"
                                                            action="{{ route('admin.partner.destroy', $item->id) }}"

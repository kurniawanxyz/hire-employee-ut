                        ...
                        <div class="my-3 px-3 d-flex">
                            <div class="form-check me-3">
                                <input class="form-check-input" type="radio" name="recruit" id="recruit1"
                                    value="no" {{ old('recruit') == 'no' ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="recruit" id="recruit2"
                                    value="yes" {{ old('recruit') == 'yes' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6 px-3">
                        <div>
                            ...
                            <input type="text" name="presentation_title_ps" id="presentation_title_ps"
                                class="form-control @error("presentation_title_ps") is-invalid @enderror" placeholder="Enter name of presentation"
                                value="{{ old("presentation_title_ps") }}">
                        ...
                        <div class="my-3">
                            ...
                            <input type="number" name="presentation_ps_score" id="presentation_ps_score"
                                class="form-control @error("presentation_ps_score") is-invalid @enderror" placeholder="Enter PS presentation Score"
                                value="{{ old("presentation_ps_score") }}">
                    ...
                    <div class="col-md-6 px-3">
                        <div>
                            ...
                            <input type="text" name="presentation_title_ts" id="presentation_title_ts"
                                class="form-control @error("presentation_title_ts") is-invalid @enderror" placeholder="Enter name of presentation"
                                value="{{ old("presentation_title_ts") }}">
                        ...
                        <div class="my-3">
                            ...
                            <input type="number" name="presentation_ts_score" id="presentation_ts_score"
                                class="form-control @error("presentation_ts_score") is-invalid @enderror" placeholder="Enter TS presentation Score"
                                value="{{ old("presentation_ts_score") }}">

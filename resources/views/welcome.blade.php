...
<div id="hero-section" data-number="3" data-image-1="{{asset('assets/img/slider/9.jpg')}}" data-image-2="{{asset('assets/img/slider/8.jpg')}}" data-image-3="{{asset('assets/img/slider/1.jpg')}}" data-effect="fade">
    <div class="hero-content">
        <div class="hero-title scroll" data-min="28px" data-max="80px">
            ...
            <h1>THREE DIVISONS</h1>
            <h1>INFINITE POTENTIAL</h1>
        </div>

        <div class="hero-text">
            <p class="font-weight-600 letter-spacing-1px">EXCELLENCE IN CONSTRUCITON <span class="text-accent-color">SINCE 1981</span></p>
        </div>
                ...
                <div class="page-content">
                                    ...
                                    <div class="wprt-content-box style-1">
                                        <div class="wprt-icon-box icon-effect-2 icon-left">
                                            ...
                                            <div class="content-wrap">
                                                <h3 class="dd-title text-white font-size-19"><a href="#">BRIDGE DIVISION</a></h3>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="wprt-content-box style-1">
                                        <div class="wprt-icon-box icon-effect-2 icon-left">
                                            ...
                                            <div class="content-wrap">
                                                <h3 class="dd-title text-white font-size-19"><a href="#">RAILROAD DIVISION</a></h3>
                                                <div class="dd-link"><a href="#">READ MORE</a></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="wprt-content-box style-1">
                                        <div class="wprt-icon-box icon-effect-2 icon-left">
                                            ...
                                            <div class="content-wrap">
                                                <h3 class="dd-title text-white font-size-19"><a href="#">INDUSTRIAL DIVISION</a></h3>
                                                <div class="dd-link"><a href="#">READ MORE</a></div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <section class="wprt-section facts-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="wprt-spacer" data-desktop="110" data-mobi="80" data-smobi="60"></div>
                                </div><!-- /.col-md-12 -->
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="wprt-counter text-center white-type has-plus">
                                        <div class="number" data-speed="5000" data-to="336" data-in-viewport="yes">336</div>
                                        <div class="wprt-lines style-2 custom-1 margin-top-10 margin-bottom-10">
                                            <div class="line-1"></div>
                                        </div>
